...
class InvestmentPlannerEngine {
    ...
    private static func generatePlan3(
        ...
        return Plan3Result(
            ...
            moderatePortfolio: moderatePortfolio,
            aggressivePortfolio: aggressivePortfolio
        )
    }
    ...
    private static func buildPlan3Portfolio(risk: AstraRiskLevel, amount: Double) -> PortfolioBlueprint {
        ...
        case .high: // Aggressive: Balanced with a safe anchor
            allocations = [
                AssetAllocation(
                    name: "Small & Mid Cap Alpha Stocks",
                    percentage: 40,
                    expectedCAGR: 19.5,
                    riskLevel: .high,
                    role: "Aggressive Alpha",
                    description: "Focused direct equity picks targeting high earnings growth and market leadership in emerging segments.",
                    fundExamples: ["Direct Alpha Portfolio", "Small Cap Focus Baskets"],
                    howItWorks: "Direct equity holding with high earnings compounding in fast-expanding industrial and technology sectors.",
                    whyIncluded: "Engineered to maximize alpha and generate substantial arbitrage spread over borrowing costs.",
                    returns5Y: 26.5,
                    returns10Y: 19.8,
                    returns15Y: 17.2,
                    benchmarkIndex: "Nifty MidSmallcap 400 TRI",
                    sourceName: "NSE India Indices",
                    sourceURL: "https://www.nseindia.com"
                ),
                AssetAllocation(
                    name: "Momentum Growth Mutual Funds",
                    percentage: 30,
                    expectedCAGR: 18.0,
                    riskLevel: .high,
                    role: "Momentum Alpha",
                    description: "Rule-based systematic funds investing in stocks showing the strongest upward price momentum.",
                    fundExamples: ["UTI Nifty200 Momentum 30 Index", "Motilal Oswal Nifty 200 Momentum 30"],
                    howItWorks: "Systematically rides market trends with dynamic multi-factor rules and quarterly rebalancing.",
                    whyIncluded: "Captures outsized momentum upside during market expansions to boost net portfolio alpha.",
                    returns5Y: 24.1,
                    returns10Y: 19.5,
                    returns15Y: 17.6,
                    benchmarkIndex: "Nifty200 Momentum 30 TRI",
                    sourceName: "NSE India Indices",
                    sourceURL: "https://www.nseindia.com"
                ),
                AssetAllocation(
                    name: "Small-Cap Alpha Mutual Funds",
                    percentage: 15,
                    expectedCAGR: 18.5,
                    riskLevel: .high,
                    role: "Institutional Growth",
                    description: "High-conviction small-cap picks through institutional mutual fund managers.",
                    fundExamples: ["Quant Small Cap Fund", "Nippon India Small Cap Fund"],
                    howItWorks: "Professional research identifies mispriced and rapidly scaling high-growth businesses.",
                    whyIncluded: "Harnesses long-term compounding of India's fastest expanding enterprises.",
                    returns5Y: 25.4,
                    returns10Y: 18.9,
                    returns15Y: 16.8,
                ...
                AssetAllocation(
                    name: "Large Cap Index (Safety Anchor)",
                    percentage: 10,
                    expectedCAGR: 13.5,
                    riskLevel: .mid,
                    role: "Safety Anchor",
                    description: "Provides portfolio balance and downside liquidity cushion during broad market pullbacks.",
                    fundExamples: ["HDFC Nifty 50 Index Fund", "SBI Nifty 50 ETF"],
                    howItWorks: "Passive exposure to India's top 50 corporate giants with minimal tracking error.",
                    whyIncluded: "Acts as a volatility shock absorber to safeguard portfolio collateral.",
                    returns5Y: 16.4,
                    returns10Y: 13.5,
                    returns15Y: 12.6,
                ...
                AssetAllocation(
                    name: "Liquid / Short-Term Fund",
                    percentage: 5,
                    expectedCAGR: 6.5,
                    riskLevel: .low,
                    role: "Liquidity Reserve",
                    description: "Ultra-safe short-dated debt securities for tactical liquidity and emergency needs.",
                    fundExamples: ["ICICI Prudential Liquid Fund", "Aditya Birla Sun Life Liquid"],
                    howItWorks: "Invests in overnight and short-term paper maturing within 91 days. Minimal price fluctuation.",
                    whyIncluded: "Guarantees immediate liquidity buffer for loan stress mitigation.",
                    returns5Y: 5.8,
                    returns10Y: 6.6,
                    returns15Y: 6.9,
                    benchmarkIndex: "CRISIL Liquid Debt Index",
        ...
        case .mid: // Moderate: Diversified exposure
            allocations = [
                AssetAllocation(
                    name: "Multi-Cap Growth Mutual Funds",
                    percentage: 35,
                    expectedCAGR: 14.5,
                    riskLevel: .mid,
                    role: "Adaptive Core Growth",
                    description: "Flexible allocation across all market capitalizations (large, mid, and small cap).",
                    fundExamples: ["Parag Parikh Flexi Cap Fund", "Canara Robeco Multi Cap Fund"],
                    howItWorks: "Fund manager dynamically shifts money based on where the best opportunities are across market cycles.",
                    whyIncluded: "Offers optimal risk-adjusted returns by adapting to varying economic and sector conditions.",
                    returns5Y: 18.1,
                    returns10Y: 14.8,
                    returns15Y: 13.9,
                ...
                AssetAllocation(
                    name: "Bluechip & Mid-Cap Stocks",
                    percentage: 25,
                    expectedCAGR: 16.0,
                    riskLevel: .high,
                    role: "Direct Compounders",
                    description: "A mix of stable industry leaders and emerging high-growth corporate winners.",
                    fundExamples: ["HDFC Bank", "Reliance Industries", "Trent", "Varun Beverages"],
                    howItWorks: "Direct equity holding with exposure to companies having strong competitive moats and earnings compounding.",
                    whyIncluded: "Drives higher capital appreciation to outpace debt cost and build long-term wealth.",
                    returns5Y: 17.8,
                    returns10Y: 14.9,
                    returns15Y: 14.1,
                ...
                AssetAllocation(
                    name: "Large & Mid Cap Mutual Funds",
                    percentage: 20,
                    expectedCAGR: 14.0,
                    riskLevel: .mid,
                    role: "Balanced Compounder",
                    description: "Institutional exposure to India's top 250 corporations (minimum 35% large cap, 35% mid cap).",
                    fundExamples: ["Mirae Asset Large & Midcap Fund", "HDFC Large and Mid Cap Fund"],
                    howItWorks: "Combines the proven resilience of top 100 leaders with the higher growth velocity of mid-caps.",
                    whyIncluded: "Balances growth potential with enterprise stability for dependable wealth accumulation.",
                    returns5Y: 19.2,
                    returns10Y: 15.6,
                    returns15Y: 14.3,
                ...
                AssetAllocation(
                    name: "Corporate Bond Fund (Stable)",
                    percentage: 15,
                    expectedCAGR: 7.8,
                    riskLevel: .low,
                    role: "Stability Anchor",
                    description: "Safe fixed-income component investing in high-quality debt instruments issued by companies and the government.",
                    fundExamples: ["SBI Corporate Bond Fund", "ICICI Pru Corporate Bond"],
                    howItWorks: "Fixed-income instruments that pay regular interest. Less volatile than stocks with predictable returns.",
                    whyIncluded: "Provides capital protection and liquidity to cushion against market volatility.",
                    returns5Y: 7.4,
                    returns10Y: 8.1,
                    returns15Y: 8.3,
                ...
                AssetAllocation(
                    name: "Small Cap Alpha (Kicker)",
                    percentage: 5,
                    expectedCAGR: 18.0,
                    riskLevel: .high,
                    role: "High-Growth Kicker",
                    description: "Small tactical exposure to dynamic small-cap companies for higher returns.",
                    fundExamples: ["Tata Small Cap Fund", "Nippon India Small Cap Fund"],
                    howItWorks: "Aggressive market-linked growth. High price swings but high long-term gains over 5+ year horizons.",
                    whyIncluded: "Provides an upside performance kicker to enhance final corpus value.",
                    returns5Y: 25.4,
                    returns10Y: 18.9,
                    returns15Y: 16.8,
                    benchmarkIndex: "Nifty Smallcap 250 TRI",
        ...
        case .low: // Conservative: 50% in Low Risk Investment Option
            allocations = [
                AssetAllocation(
                    ...
                    expectedCAGR: 7.8,
                    riskLevel: .low,
                    role: "Stability & Capital Protection",
                    description: "Invests in high-quality debt instruments issued by companies and the government.",
                    fundExamples: ["Example: Corporate bond mutual funds", "SBI Corporate Bond Fund", "HDFC Corporate Bond"],
                    howItWorks: "Fixed-income instruments that pay regular interest. Less volatile than stocks.",
                    whyIncluded: "Provides capital protection and steady returns to offset market risks.",
                    returns5Y: 7.4,
                    returns10Y: 8.1,
                ...
                AssetAllocation(
                    name: "Large Cap (Bluechip) Index MFs",
                    percentage: 25,
                    expectedCAGR: 13.5,
                    riskLevel: .mid,
                    role: "Stable Long-Term Growth",
                    description: "Core equity allocation in top 50 well-established companies in India.",
                    fundExamples: ["UTI Nifty 50 Index Fund", "HDFC Index Nifty 50 Plan"],
                    howItWorks: "Market-linked. Value changes based on the macroeconomic growth of India's biggest companies.",
                    whyIncluded: "Captures the growth of the broader economy with lower volatility than mid or small caps.",
                    returns5Y: 16.4,
                    returns10Y: 13.5,
                    returns15Y: 12.6,
                    benchmarkIndex: "Nifty 50 TRI",
                ...
                AssetAllocation(
                    name: "Mid-Cap Quality Focus Funds",
                    percentage: 15,
                    expectedCAGR: 15.5,
                    riskLevel: .mid,
                    role: "Quality Growth Kicker",
                    description: "Quality mid-sized companies with strong balance sheets and established leadership.",
                    fundExamples: ["Kotak Emerging Equity Fund", "Mirae Asset Midcap Fund"],
                    howItWorks: "Active fundamental selection in structural growth sectors with disciplined debt levels.",
                    whyIncluded: "Enhances returns to comfortably exceed the cost of debt while maintaining controlled volatility.",
                    returns5Y: 23.6,
                    returns10Y: 18.2,
                    returns15Y: 16.4,
                ...
                AssetAllocation(
                    name: "Gold & Sovereign Gold Bonds (SGB)",
                    percentage: 10,
                    expectedCAGR: 10.5,
                    riskLevel: .low,
                    role: "Inflation & Currency Hedge",
                    description: "Government-backed sovereign gold bonds and physical gold ETFs.",
                    fundExamples: ["RBI Sovereign Gold Bonds", "Nippon India Gold ETF"],
                    howItWorks: "Tracks the domestic price of gold plus earns 2.5% p.a. sovereign interest on SGBs.",
                    whyIncluded: "Historically inversely correlated with equities, providing a reliable safety cushion during market drawdowns.",
                    returns5Y: 14.2,
                    returns10Y: 10.8,
                    returns15Y: 10.4,
                    benchmarkIndex: "Domestic Spot Gold (INR) / RBI SGB",
